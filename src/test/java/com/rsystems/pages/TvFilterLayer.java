...
public class TvFilterLayer extends TestInitization {
	...
	public void navigationToTvScreen() throws InterruptedException {
		...
		TestInitization.sendKeySequence("ENTER", 1000,
				TestInitization.getExcelKeyValue("TvFilterLayer", "Television", "name_nl"));
		...
		if (tvGrid.equalsIgnoreCase(expectedtvGrid)) {
			reports.log(LogStatus.PASS, "Actual tvGrid Title :" + tvGrid + " and Expected tvGrid Title :"
					+ expectedtvGrid + " Test case successfully Passed");
		} else {
			FailTestCase("Actual tvGrid Title :" + tvGrid + " and Expected tvGrid Title :" + expectedtvGrid
					+ " Test case Failed");
	...
	public boolean tvFilterLayerVerify() throws InterruptedException {
		...
		if (nuHeading.equalsIgnoreCase(expectednuHeading)) {
			reports.log(LogStatus.PASS, "Actual heading Title :" + nuHeading + " and Expected heading Title :"
					+ expectednuHeading + " Test case successfully Passed");
		} else {
			FailTestCase("Actual heading Title : " + nuHeading + " and Expected heading Title : " + expectednuHeading
					+ " Test case Failed");
		}
		...
		if (actualNowOnTvHeading.equalsIgnoreCase(expectedNowOnTv)) {
			reports.log(LogStatus.PASS, "Actual NowOnTv Heading Title : " + actualNowOnTvHeading
					+ " and Expected NowOnTv Title : " + expectedNowOnTv + " Test case successfully Passed");
		} else {
			FailTestCase("Actual NowOnTv Heading Title : " + actualNowOnTvHeading + " and Expected NowOnTv Title : "
					+ expectedNowOnTv + " Test case Failed");
		}
		...
		if (actualFootballHeading.equalsIgnoreCase(expectedFootballHeading)) {
			reports.log(LogStatus.PASS,
					"Actual FootballHeading Title : " + actualFootballHeading + " and Expected FootballHeading Title : "
							+ expectedFootballHeading + " Test case successfully Passed");
		} else {
			FailTestCase("Actual FootballHeading Title : " + actualFootballHeading
					+ " and Expected FootballHeading Title : " + expectedFootballHeading + " Test case Failed");
		...
		String expectedCalenderHeading = TestInitization.getExcelKeyValue("TvFilterLayer", "FootballCalendar",
				"name_nl");
		if (actualCalenderHeading.equalsIgnoreCase(expectedCalenderHeading)) {
			reports.log(LogStatus.PASS,
					"Actual CalenderHeading Title : " + actualCalenderHeading + " and Expected CalenderHeading Title : "
							+ expectedCalenderHeading + " Test case successfully Passed");
		} else {
			FailTestCase("Actual CalenderHeading Title : " + actualCalenderHeading
					+ " and Expected CalenderHeading Title : " + expectedCalenderHeading + " Test case Failed");
		}
		...
		if (actualRadioStationsHeading.equalsIgnoreCase(expectedRadioStations)) {
			reports.log(LogStatus.PASS,
					"Actual radio Stations Heading Title : " + actualRadioStationsHeading
							+ " and Expected radio Stations Heading Title : " + expectedRadioStations
							+ " Test case successfully Passed");
		} else {
			FailTestCase("Actual radio Stations Heading Title : " + actualRadioStationsHeading
					+ " and Expected radio Stations Heading Title : " + expectedRadioStations + " Test case Failed");
		}
		...
		if (actualSearchHeading.equalsIgnoreCase(expectedSearchHeading)) {
			reports.log(LogStatus.PASS,
					"Actual Search Heading Title : " + actualSearchHeading + " and Expected Search Heading Title : "
							+ expectedSearchHeading + " Test case successfully Passed");
		} else {
			FailTestCase("Actual Search Heading Title : " + actualSearchHeading
					+ " and Expected Search Heading Title : " + expectedSearchHeading + " Test case Failed");
		}
