...
public class ReportGenerationForGraph {
	...
	public void readAndWriteFromfile() throws IOException {
		...
		File UIFile = new File(TestInitization.currentExecutionReportPath+File.separator
				+ "RunWiseReport.html");
		...
		while ((count = inputStream.readLine()) != null) {
			...
			count  = count.replaceAll("@Date",  "'"+DateFormatter.format(TestInitization.executionStartTime) + "'");
			count = count.concat("\n");
