...
public class HotKeysTestCase extends TestInitization
{
	...
	/*This test case is navigating to Shop screen & Epg screen and from there clicking on the TV Hot key it was returning to the TV screen*/
	...
	public void tc_BCDTVDT0101_navigateMultipleScreensToDTV() throws InterruptedException
	{
		...
		dtv.changeChnlAndInfoBannerValidation(Unicode.VK_TV);
		keys.navigateToDtvScreenFromEpgScreen();
		driver.switchTo().frame(TestInitization.getCurrentFrameIndex());
		dtv.changeChnlAndInfoBannerValidation(Unicode.VK_TV);    
	}
	
	//This test case is navigating to Radio screen and verifying the channel number
	...
	//This test case is navigating from Radio screen to DTV screen and verifying the channel number
